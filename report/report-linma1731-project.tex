...
If one takes the Hadamard division of the covariance matrix by the inverse of the Fisher matrix, the result should converge to a matrix of ones \cite{wiki:hadamard}.
